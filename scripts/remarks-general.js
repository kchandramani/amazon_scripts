...
selectList.style.position = 'fixed'; // changed from absolute
...
const textToInsert = {
    'Need Photo': 'CX need Photos of Delivery Location',
    'No Entrance': 'No Entrance on CX given road',
    'Unit Not Locatble': 'Customer given unit is not locatable in any 3ps or Site Map',
...
function alignDropdown() {
    ...
    selectList.style.left = (rect.left + 200) + 'px';
    selectList.style.top = (rect.bottom + 10) + 'px';
}

// run initially
setTimeout(alignDropdown, 300);

// update on scroll/resize
window.addEventListener('scroll', alignDropdown);
